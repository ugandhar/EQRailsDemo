...
ActiveRecord::Schema.define(:version => 20110221214607) do
...
#   Unknown type 'publication_type' for column 'publication_type'
  ...
  create_table "mol_matrix_cells", :force => true do |t|
    ...
    t.boolean  "is_committed",          :null => false
  ...
  create_table "primers", :force => true do |t|
    ...
    t.integer  "primer_target_organisms_id"
    t.integer  "primer_purification_methods_id"
  end
